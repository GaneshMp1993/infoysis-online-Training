...
public class Samsung {
	...
	@GenericGenerator(name = "abc",strategy = "increment")//id is generated by hibernate framework,,,,,,
	@Column(name = "ID")
	private int id;
	@Column(name = "NAME")
	private String name;
	...
	public Samsung( String name, String color, double price, int ram, boolean is_Finger_Print_Supported) {
		super();
